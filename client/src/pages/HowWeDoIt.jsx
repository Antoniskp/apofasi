const pipeline = [
  {
    ...
    description:
      "Ο developer δίνει οδηγίες στο AI, το AI γράφει τον κώδικα και συγκεντρώνει ιδέες, οργανώνει δεδομένα και σχεδιάζει γρήγορα πρωτότυπες εμπειρίες.",
    badge: "Βήμα 1"
  },
  {
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="card">
          <h2>Διαδικασία: AI → GitHub → Server</h2>
          <p className="muted">
